...
import deep_models_uncertainty as dmu  # noqa: E402  (import in sola lettura, invariato)
...
MODEL_NAME = "MLP-Gaussian-MCDropout-Optuna"
N_MC_SAMPLES = 100
...
def main():
    ...
    metrics_path = os.path.join(args.out, "uncertainty_metrics.csv")
    preds_path = os.path.join(args.out, "uncertainty_preds.csv")
    hparams_path = os.path.join(args.out, "uncertainty_hyperparameters.csv")
